...
spotify_state=(
  ...
  slider.background.color=$GRUVBOX_FG4
  slider.highlight_color=$GRUVBOX_BRIGHT_GREEN
...
spotify_shuffle=(
  ...
  icon.color=$GRUVBOX_BG0
  icon.highlight_color=$GRUVBOX_FG4
  label.drawing=off
  script="$PLUGIN_DIR/spotify.sh"
  y_offset=-45
)
...
spotify_controls=(
  background.color=$GRUVBOX_BRIGHT_GREEN
